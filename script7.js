document.addEventListener('DOMContentLoaded', () => {
    ...
    function loadImages() {
        ...
        referenceImage.src = './Wild samples/7/lq.png'; 
        ...
        const imageFiles = ['gfpgan.png', 'difface.png', 'dr2.jpg', 'difbir.png', 'pgdiff.png', 'igcp.png', 'codeformer.png', 'vqfr.png', 'gpen.png'];
        
        superResImages.forEach((img, index) => {
            const imagePath = `./Wild samples/7/${imageFiles[index]}`;
