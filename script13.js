document.addEventListener('DOMContentLoaded', () => {
    ...
    function loadImages() {
        ...
        referenceImage.src = './Wild samples/13/lq.png'; 
        ...
        const imageFiles = ['igcp.png', 'gfpgan.png', 'dr2.jpg', 'gpen.png', 'difbir.png', 'vqfr.png', 'difface.png', 'codeformer.png', 'pgdiff.png'];
        
        superResImages.forEach((img, index) => {
            const imagePath = `./Wild samples/13/${imageFiles[index]}`;
