document.addEventListener('DOMContentLoaded', () => {
    ...
    function loadImages() {
        ...
        referenceImage.src = './Wild samples/12/lq.png'; 
        ...
        const imageFiles = ['difface.png', 'igcp.png', 'gfpgan.png', 'pgdiff.png', 'difbir.png', 'gpen.png', 'codeformer.png', 'dr2.jpg', 'vqfr.png'];
        
        superResImages.forEach((img, index) => {
            const imagePath = `./Wild samples/12/${imageFiles[index]}`;
