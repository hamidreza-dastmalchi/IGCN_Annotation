document.addEventListener('DOMContentLoaded', () => {
    ...
    function loadImages() {
        ...
        referenceImage.src = './Wild samples/15/lq.png'; 
        ...
        const imageFiles = ['difbir.png', 'dr2.jpg', 'gpen.png', 'codeformer.png', 'difface.png', 'pgdiff.png', 'gfpgan.png', 'igcp.png', 'vqfr.png'];
        
        superResImages.forEach((img, index) => {
            const imagePath = `./Wild samples/15/${imageFiles[index]}`;
