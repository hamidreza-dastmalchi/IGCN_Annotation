document.addEventListener('DOMContentLoaded', () => {
    ...
    function loadImages() {
        ...
        referenceImage.src = './Wild samples/2/lq.png'; 
        ...
        const imageFiles = ['gpen.png', 'difface.png', 'dr2.jpg', 'pgdiff.png', 'codeformer.png', 'igcp.png', 'vqfr.png', 'difbir.png', 'gfpgan.png'];
        
        superResImages.forEach((img, index) => {
            const imagePath = `./Wild samples/2/${imageFiles[index]}`;
