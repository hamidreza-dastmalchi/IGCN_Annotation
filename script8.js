document.addEventListener('DOMContentLoaded', () => {
    ...
    function loadImages() {
        ...
        referenceImage.src = './Wild samples/8/lq.png'; 
        ...
        const imageFiles = ['vqfr.png', 'difbir.png', 'gpen.png', 'difface.png', 'igcp.png', 'pgdiff.png', 'dr2.jpg', 'codeformer.png', 'gfpgan.png'];
        
        superResImages.forEach((img, index) => {
            const imagePath = `./Wild samples/8/${imageFiles[index]}`;
