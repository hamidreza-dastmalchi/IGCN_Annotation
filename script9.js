document.addEventListener('DOMContentLoaded', () => {
    ...
    function loadImages() {
        ...
        referenceImage.src = './Wild samples/9/lq.png'; 
        ...
        const imageFiles = ['gpen.png', 'difface.png', 'igcp.png', 'difbir.png', 'codeformer.png', 'vqfr.png', 'dr2.jpg', 'gfpgan.png', 'pgdiff.png'];
        
        superResImages.forEach((img, index) => {
            const imagePath = `./Wild samples/9/${imageFiles[index]}`;
