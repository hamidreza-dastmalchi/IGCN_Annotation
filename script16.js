document.addEventListener('DOMContentLoaded', () => {
    ...
    function loadImages() {
        ...
        referenceImage.src = './Wild samples/16/lq.png'; 
        ...
        const imageFiles = ['gpen.png', 'gfpgan.png', 'dr2.jpg', 'igcp.png', 'pgdiff.png', 'difface.png', 'difbir.png', 'codeformer.png', 'vqfr.png'];
        
        superResImages.forEach((img, index) => {
            const imagePath = `./Wild samples/16/${imageFiles[index]}`;
