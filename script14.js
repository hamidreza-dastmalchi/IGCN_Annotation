document.addEventListener('DOMContentLoaded', () => {
    ...
    function loadImages() {
        ...
        referenceImage.src = './Wild samples/14/lq.png'; 
        ...
        const imageFiles = ['pgdiff.png', 'dr2.jpg', 'difface.png', 'vqfr.png', 'codeformer.png', 'difbir.png', 'gpen.png', 'gfpgan.png', 'igcp.png'];
        
        superResImages.forEach((img, index) => {
            const imagePath = `./Wild samples/14/${imageFiles[index]}`;
