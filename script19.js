document.addEventListener('DOMContentLoaded', () => {
    ...
    function loadImages() {
        ...
        referenceImage.src = './Wild samples/19/lq.png'; 
        ...
        const imageFiles = ['dr2.jpg', 'gfpgan.png', 'codeformer.png', 'pgdiff.png', 'vqfr.png', 'gpen.png', 'difbir.png', 'igcp.png', 'difface.png'];
        
        superResImages.forEach((img, index) => {
            const imagePath = `./Wild samples/19/${imageFiles[index]}`;
