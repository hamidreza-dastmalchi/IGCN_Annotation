document.addEventListener('DOMContentLoaded', () => {
    ...
    function loadImages() {
        ...
        referenceImage.src = './Wild samples/3/lq.png'; 
        ...
        const imageFiles = ['pgdiff.png', 'gfpgan.png', 'vqfr.png', 'codeformer.png', 'difface.png', 'gpen.png', 'difbir.png', 'igcp.png', 'dr2.jpg'];
        
        superResImages.forEach((img, index) => {
            const imagePath = `./Wild samples/3/${imageFiles[index]}`;
