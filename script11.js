document.addEventListener('DOMContentLoaded', () => {
    ...
    function loadImages() {
        ...
        referenceImage.src = './Wild samples/11/lq.png'; 
        ...
        const imageFiles = ['dr2.jpg', 'vqfr.png', 'codeformer.png', 'gpen.png', 'pgdiff.png', 'difbir.png', 'gfpgan.png', 'igcp.png', 'difface.png'];
        
        superResImages.forEach((img, index) => {
            const imagePath = `./Wild samples/11/${imageFiles[index]}`;
