document.addEventListener('DOMContentLoaded', () => {
    ...
    function loadImages() {
        ...
        referenceImage.src = './Wild samples/18/lq.png'; 
        ...
        const imageFiles = ['codeformer.png', 'difbir.png', 'gpen.png', 'vqfr.png', 'igcp.png', 'difface.png', 'dr2.jpg', 'pgdiff.png', 'gfpgan.png'];
        
        superResImages.forEach((img, index) => {
            const imagePath = `./Wild samples/18/${imageFiles[index]}`;
