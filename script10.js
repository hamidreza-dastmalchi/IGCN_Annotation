document.addEventListener('DOMContentLoaded', () => {
    ...
    function loadImages() {
        ...
        referenceImage.src = './Wild samples/10/lq.png'; 
        ...
        const imageFiles = ['codeformer.png', 'gpen.png', 'pgdiff.png', 'gfpgan.png', 'vqfr.png', 'difface.png', 'dr2.jpg', 'igcp.png', 'difbir.png'];
        
        superResImages.forEach((img, index) => {
            const imagePath = `./Wild samples/10/${imageFiles[index]}`;
