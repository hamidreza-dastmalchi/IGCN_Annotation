document.addEventListener('DOMContentLoaded', () => {
    ...
    function loadImages() {
        ...
        referenceImage.src = './Wild samples/17/lq.png'; 
        ...
        const imageFiles = ['gfpgan.png', 'codeformer.png', 'difbir.png', 'pgdiff.png', 'igcp.png', 'difface.png', 'vqfr.png', 'gpen.png', 'dr2.jpg'];
        
        superResImages.forEach((img, index) => {
            const imagePath = `./Wild samples/17/${imageFiles[index]}`;
