document.addEventListener('DOMContentLoaded', () => {
    ...
    function loadImages() {
        ...
        referenceImage.src = './Wild samples/6/lq.png'; 
        ...
        const imageFiles = ['codeformer.png', 'vqfr.png', 'pgdiff.png', 'dr2.jpg', 'difface.png', 'difbir.png', 'igcp.png', 'gpen.png', 'gfpgan.png'];
        
        superResImages.forEach((img, index) => {
            const imagePath = `./Wild samples/6/${imageFiles[index]}`;
